<template>
  <div class="addReport">
    ...
    <div class="row">
      ...
      <div class="col-md-10">
        <InputItem inputType="text" textName="matchTime" placeholder="如：2019-07-17 02:45:00" :error="errors.matchTime" v-model="matchTime"/>
        <div class="invalid-feedback d-block">{{errors.matchTime}}</div>
      </div>
    </div>
    <div class="row">
      <div class="col-md-2" >
        <LabelItem textName="欧赔代表："/>
      </div>
      <div class="col-md-3">
      ...
      <div class="col-md-7">
        <InputGroup inputType="text" :error="errors.Euroodds" title1="胜" title2="平" title3="负" v-model="Euroodd"/>
        <div class="invalid-feedback d-block">{{errors.Euroodds}}</div>
      </div>
    </div>
    <div class="row">
      <div class="col-md-2">
        <LabelItem textName="亚盘代表："/>
      </div>
      <div class="col-md-3">
        <div class="form-group">
          <span class="mx-2 my-2">机构：</span>
      ...
      <div class="col-md-7">
        <InputGroup inputType="text" :error="errors.Asiaodds" title1="水位" title2="盘口" title3="水位" v-model="Asiaodd"/>
        <div class="invalid-feedback d-block">{{errors.Asiaodds}}</div>
      </div>
    </div>
    <div class="row">
      <div class="col-md-2" >
      ...
      <div class="col-md-2 my-3">
        <div class="form-check">
          <input class="form-check-input" type="radio" name="isSingleMatch" id="isSingleMatch1" v-model="isSingleMatch" value="1">
      ...
      <div class="col-md-2 my-3">
        <div class="form-check">
          <input class="form-check-input" type="radio" name="isSingleMatch" id="isSingleMatch2" v-model="isSingleMatch" value="0" checked>
    ...
    <div class="row">
      ...
      <div class="col-md-10">
        <InputItem inputType="text" textName="hostInjury" placeholder="如：奥巴梅杨,拉卡泽特" :error="errors.hostInjury" v-model="hostInjury"/>
    ...
    <div class="row">
      ...
      <div class="col-md-10">
        <InputItem inputType="text" textName="awayInjury" placeholder="如：哈里凯恩,埃里克森" :error="errors.awayInjury" v-model="awayInjury"/>
    ...
    <div class="row">
      ...
      <div class="col-md-10">
        <textAreaItem rows="3" name="hostExpectLineup" placeholder="如：莱诺/穆斯塔菲，帕帕斯塔索普洛斯，蒙雷亚尔/科拉希纳茨，扎卡，托雷拉，奈尔斯/厄齐尔，奥巴梅杨，拉卡泽特"
    ...
    <div class="row">
      ...
      <div class="col-md-10">
        <textAreaItem rows="3" name="awayExpectLineup" placeholder="如：莱诺/穆斯塔菲，帕帕斯塔索普洛斯，蒙雷亚尔/科拉希纳茨，扎卡，托雷拉，奈尔斯/厄齐尔，奥巴梅杨，拉卡泽特"
